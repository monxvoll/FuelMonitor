...
public class DieselVehicule extends GasVehicule {

    public DieselVehicule(String name , int initialAmount , int turnOnSpendAmount , int speedUpSpendAmount ) throws MyException {
